...
description: An implementation of K-Means Clustering written in C++23 using MPI and Boost.
...
I found that the parallel implementation had a near-linear speedup over the serial implementation, showing,
at this problem size, optimal parallelism and optimal communication.
