...
const DependencyItem = React.memo(({name, url, version, license, heading}: Dependency) => (
    <a
        ...
        className="bg-slate-200 dark:bg-slate-800 text-slate-800 dark:text-slate-50 hover:bg-slate-300 dark:hover:bg-slate-700 active:bg-slate-400 dark:active:bg-slate-600 px-6 py-3 rounded-md shadow-md flex flex-col items-center justify-center text-center transition"
    >
